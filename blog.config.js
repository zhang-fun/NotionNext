...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'zhang-fun-6c93dc148eef43bc9d6fb4e9234713e8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '有趣的张', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '张兴传', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'zhang.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'zhang.fun,博客,张兴传,张兴传的博客,ai,chatGPT,blog', // 网站关键词 英文逗号隔开
